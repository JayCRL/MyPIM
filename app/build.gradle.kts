...
android {
    namespace = "com.example.mypim"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.mypim"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.room:room-ktx:2.6.1") // Room with KTX
    ...
    implementation("androidx.hilt:hilt-navigation-compose:1.1.0") // Hilt for Compose Navigation
